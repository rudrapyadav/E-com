    ...
    return (
        <div>
            ...
            <div className="top mb-5 px-5 mt-5">
                <div className=" bg-yellow-400 py-5 border border-pink-100 rounded-lg">
            ...
            <div className="px-5">
                ...
                <div className="mid mb-5">
                    {/* main  */}
                    <div className=" bg-cyan-200 py-5 rounded-xl border border-pink-100">
                        {/* image  */}
                        <div className="flex justify-center">
                        <img alt="admin-img" className="w-20 h-20 mb-4 object-cover object-center rounded-full inline-block border-2 border-blue-600 bg-gray-100" src="../img/testimonial1.jpg" />
                        </div>
                        {/* text  */}
                           <div className="">
                            {/* Name  */}
