...
const UserDashboard = () => {
    ...
    return (
        <Layout>
            ...
            <div className=" bg-yellow-400 py-5 mb-5 mt-5 border border-pink-100 rounded-lg">
                    <h1 className=" text-center text-2xl font-bold text-black-500">User Dashboard</h1>
                </div>
                {/* Top  */}
                <div className="top ">
                    {/* main  */}
